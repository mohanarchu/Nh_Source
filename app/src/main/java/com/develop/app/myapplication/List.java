...
public class List extends AsyncTask<String, String, JSONObject> {
    ...
    public List(String currentVersion, Context context){
    ...
    public void showForceUpdateDialog(){
        @SuppressLint("InlinedApi") AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper(context,
